...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            ...
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" class="dark:hidden">
                <div class="flex items-center justify-center ">
                    {{-- <img src="/images/logo/logo-icon.svg" alt="Logo" width="32" height="32" alt=""> --}}
                    <span alt="Logo" width="32" height="32">EPS</span>
                    <span class="ml-3"> Esquilona Prime Stay</span>
                </div>
            </div>
            ...
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                ...
                <div class="flex items-center justify-center ">
                    {{-- <img src="/images/logo/logo-icon.svg" alt="Logo" width="32" height="32" alt="">
                    <span class="text-white ml-3 ">EPS - Esquilona Prime Stay</span> --}}
                    <span alt="Logo" width="32" height="32" class="text-gray-300">EPS</span>
                    <span class="text-gray-300 ml-3">Esquilona Prime Stay</span>
                </div>
            </div>
            ...
            {{-- <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                ...
                height="40" /> --}}
            <div x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen" class="hidden dark:block">
                <span alt="Logo" width="32" height="32" class="text-gray-300">EPS</span>
            </div>
